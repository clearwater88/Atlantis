...
& & + \sum_{\vec{g}}  \prod_{g_{b',k}} \mu_{g_{b',k} \rightarrow \fb1}(g_{b',k})- \sum_{\vec{g}}  \prod_{g_{b',k}} \mu_{g_{b',k} \rightarrow \fb1}(g_{b',k}=0) \nonumber \\
&=& \epsilon \times \prod_{g_{b',k}} \mu_{g_{b',k} \rightarrow \fb1}(g_{b',k}=0)  \\
& & +1 - \prod_{g_{b',k}} \sum_{g_{b',k}}  \mu_{g_{b',k} \rightarrow \fb1}(g_{b',k}=0) \nonumber
\end{eqnarray}
...
\begin{eqnarray}
\mGbkFb3(g_{b,k}) = \prod_{b' \neq b} \mu_{f_{b'}^3 \rightarrow g_{b,k}}(g_{b,k})
\end{eqnarray}

Note that $ \mu_{f_{b'}^3 \rightarrow g_{b,k}}(g_{b,k})$ might need to be ``re-expanded'' to the proper domain of $g_{b,k}$.
